...
(function(){
  ...
  /* O botão flutuante de contato e a métrica de cliques saíram daqui para
     `af-contato.v1.js`: aquele arquivo entra em TODA página (inclusive receita.html e pet.html,
     que têm nav própria e não podem carregar este a28 inteiro sem duplicar o toggle do menu). */
})();
